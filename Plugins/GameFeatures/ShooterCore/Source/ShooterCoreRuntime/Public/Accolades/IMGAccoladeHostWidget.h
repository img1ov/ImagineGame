...
#include "Accolades/IMGAccoladeDefinition.h"
#include "AsyncMixin.h"
#include "CommonUserWidget.h"
#include "GameFramework/GameplayMessageSubsystem.h"

#include "IMGAccoladeHostWidget.generated.h"

class UObject;
class USoundBase;
class UUserWidget;
struct FDataRegistryAcquireResult;
struct FIMGNotificationMessage;
...
class UIMGAccoladeHostWidget : public UCommonUserWidget, public FAsyncMixin
{
	GENERATED_BODY()
...
private:
	...
	void OnNotificationMessage(FGameplayTag Channel, const FIMGNotificationMessage& Notification);
