...
public:
	...
	UE_API void GetVisibleTargets(const FAimAssistFilter& Filter, const FAimAssistSettings& Settings, const FAimAssistOwnerViewData& OwnerData, const TArray<FIMGAimAssistTarget>& OldTargets, OUT TArray<FIMGAimAssistTarget>& OutNewTargets);
...
protected:
	...
	UE_API void DetermineTargetVisibility(FIMGAimAssistTarget& Target, const FAimAssistSettings& Settings, const FAimAssistFilter& Filter, const FAimAssistOwnerViewData& OwnerData);
