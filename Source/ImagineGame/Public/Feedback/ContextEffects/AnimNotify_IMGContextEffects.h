...
#include "AnimNotify_IMGContextEffects.generated.h"
...
struct IMAGINEGAME_API FIMGContextEffectAnimNotifyVFXSettings
{
	GENERATED_BODY()
 ...
 */
USTRUCT(BlueprintType)
struct IMAGINEGAME_API FIMGContextEffectAnimNotifyAudioSettings
{
	GENERATED_BODY()
 ...
 */
USTRUCT(BlueprintType)
struct IMAGINEGAME_API FIMGContextEffectAnimNotifyTraceSettings
{
	GENERATED_BODY()
 ...
 */
USTRUCT(BlueprintType)
struct IMAGINEGAME_API FIMGContextEffectAnimNotifyPreviewSettings
{
	GENERATED_BODY()
	...
	// Preview Library
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = Preview, meta = (AllowedClasses = "/Script/ImagineGame.IMGContextEffectsLibrary"))
...
class IMAGINEGAME_API UAnimNotify_IMGContextEffects : public UAnimNotify
{
	GENERATED_BODY()

public:
	UAnimNotify_IMGContextEffects();
	...
	// Scale to spawn the particle system at
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "AnimNotify", meta = (ExposeOnSpawn = true))
	FIMGContextEffectAnimNotifyVFXSettings VFXProperties;

	// Scale to spawn the particle system at
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "AnimNotify", meta = (ExposeOnSpawn = true))
	FIMGContextEffectAnimNotifyAudioSettings AudioProperties;
	...
	FIMGContextEffectAnimNotifyTraceSettings TraceProperties;
	...
	FIMGContextEffectAnimNotifyPreviewSettings PreviewProperties;
#endif
