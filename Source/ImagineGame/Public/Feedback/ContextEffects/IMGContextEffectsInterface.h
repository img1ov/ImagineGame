...
#include "IMGContextEffectsInterface.generated.h"
 ...
 */
 ...
 class IMAGINEGAME_API UIMGContextEffectsInterface : public UInterface
 {
	 GENERATED_BODY()

 };

 class IMAGINEGAME_API IIMGContextEffectsInterface : public IInterface
 {
	 GENERATED_BODY()
