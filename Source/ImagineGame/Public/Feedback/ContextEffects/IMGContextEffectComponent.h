...
#include "IMGContextEffectComponent.generated.h"
...
class IMAGINEGAME_API UIMGContextEffectComponent : public UActorComponent, public IIMGContextEffectsInterface
{
	GENERATED_BODY()

public:
	// Sets default values for this component's properties
	UIMGContextEffectComponent();
...
public:
	...
	UPROPERTY(EditAnywhere)
	TSet<TSoftObjectPtr<UIMGContextEffectsLibrary>> DefaultContextEffectsLibraries;

	UFUNCTION(BlueprintCallable)
	void UpdateEffectContexts(FGameplayTagContainer NewEffectContexts);

	UFUNCTION(BlueprintCallable)
	void UpdateLibraries(TSet<TSoftObjectPtr<UIMGContextEffectsLibrary>> NewContextEffectsLibraries);
...
private:
	...
	UPROPERTY(Transient)
	TSet<TSoftObjectPtr<UIMGContextEffectsLibrary>> CurrentContextEffectsLibraries;
