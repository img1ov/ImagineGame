...
#include "IMGActorUtilities.generated.h"
...
UCLASS()
class UIMGActorUtilities : public UBlueprintFunctionLibrary
{
	GENERATED_BODY()
...
public:
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category="IMG", meta=(WorldContext="WorldContextObject", ExpandEnumAsExecs=ReturnValue))
