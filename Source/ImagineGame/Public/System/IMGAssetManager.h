...
#include "IMGAssetManagerStartupJob.h"
#include "Engine/AssetManager.h"
#include "IMGAssetManager.generated.h"
...
class UIMGAssetManager : public UAssetManager
{
	GENERATED_BODY()

public:
	
	UE_API UIMGAssetManager();

	// Returns the AssetManager singleton object.
	UE_API static UIMGAssetManager& Get();
	...
	UE_API const UIMGGameData& GetGameData();
	UE_API UIMGPawnData* GetDefaultPawnData() const;
...
protected:
	...
	UPROPERTY(Config)
	TSoftObjectPtr<UIMGGameData> IMGGameDataPath;
	...
	UPROPERTY(Config)
	TSoftObjectPtr<UIMGPawnData> DefaultPawnData;
...
template<typename AssetType>
AssetType* UIMGAssetManager::GetAsset(const TSoftObjectPtr<AssetType>& AssetPointer, bool bKeepInMemory)
{
...
template<typename AssetType>
TSubclassOf<AssetType> UIMGAssetManager::GetSubclass(const TSoftClassPtr<AssetType>& AssetPointer, bool bKeepInMemory)
{
