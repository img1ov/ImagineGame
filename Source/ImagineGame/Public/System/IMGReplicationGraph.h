...
#include "IMGReplicationGraph.generated.h"

class AGameplayDebuggerCategoryReplicator;

DECLARE_LOG_CATEGORY_EXTERN(LogIMGRepGraph, Display, All);

/** IMG Replication Graph implementation. See additional notes in IMGReplicationGraph.cpp! */
UCLASS(transient, config=Engine)
class UIMGReplicationGraph : public UReplicationGraph
{
	GENERATED_BODY()

public:
	UIMGReplicationGraph();
...
private:
	...
	/** Classes that had their replication settings explictly set by code in UIMGReplicationGraph::InitGlobalActorClassSettings */
	TArray<UClass*> ExplicitlySetClasses;
};

UCLASS()
class UIMGReplicationGraphNode_AlwaysRelevant_ForConnection : public UReplicationGraphNode_AlwaysRelevant_ForConnection
{
	GENERATED_BODY()
...
*/
UCLASS()
class UIMGReplicationGraphNode_PlayerStateFrequencyLimiter : public UReplicationGraphNode
{
	GENERATED_BODY()
