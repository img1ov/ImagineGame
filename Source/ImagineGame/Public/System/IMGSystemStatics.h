...
#include "IMGSystemStatics.generated.h"
...
UCLASS()
class UIMGSystemStatics : public UBlueprintFunctionLibrary
{
	GENERATED_BODY()
...
public:
	...
	UFUNCTION(BlueprintCallable, BlueprintAuthorityOnly, Category="IMG", meta = (WorldContext = "WorldContextObject"))
