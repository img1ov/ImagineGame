...
#include "IMGPenetrationAvoidanceFeeler.generated.h"

/**
 * Struct defining a feeler ray used for camera penetration avoidance.
 */
USTRUCT()
struct IMAGINEGAME_API FIMGPenetrationAvoidanceFeeler
{
	GENERATED_BODY()
	...
	FIMGPenetrationAvoidanceFeeler()
	...
	FIMGPenetrationAvoidanceFeeler(const FRotator& InAdjustmentRot,
