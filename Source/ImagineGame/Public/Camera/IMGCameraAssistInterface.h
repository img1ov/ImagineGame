...
#include "IMGCameraAssistInterface.generated.h"

/** */
UINTERFACE(BlueprintType)
class IMAGINEGAME_API UIMGCameraAssistInterface : public UInterface
{
	GENERATED_BODY()
};

class IMAGINEGAME_API IIMGCameraAssistInterface
{
	GENERATED_BODY()
