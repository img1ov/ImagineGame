...
#include "IMGInputModifiers.generated.h"
...
class UIMGSettingBasedScalar : public UInputModifier
{
	GENERATED_BODY()
...
/**
 * This is a deadzone input modifier that will have it's thresholds driven by what is in the IMG Shared game settings.
 */
UCLASS(NotBlueprintable, MinimalAPI, meta = (DisplayName = "IMG Settings Driven Dead Zone"))
class UIMGInputModifierDeadZone : public UInputModifier
{
	GENERATED_BODY()
...
UENUM()
enum class EIMGTargetingType : uint8
{
...
/** Applies a scalar modifier based on the current gamepad settings in IMG Shared game settings.  */
UCLASS(NotBlueprintable, MinimalAPI, meta = (DisplayName = "IMG Gamepad Sensitivity"))
class UIMGInputModifierGamepadSensitivity : public UInputModifier
{
	GENERATED_BODY()
public:
	...
	TObjectPtr<const UIMGAimSensitivityData> SensitivityLevelTable;

protected:
	virtual FInputActionValue ModifyRaw_Implementation(const UEnhancedPlayerInput* PlayerInput, FInputActionValue CurrentValue, float DeltaTime) override;
};

/** Applies an inversion of axis values based on a setting in the IMG Shared game settings */
UCLASS(NotBlueprintable, MinimalAPI, meta = (DisplayName = "IMG Aim Inversion Setting"))
class UIMGInputModifierAimInversion : public UInputModifier
{
	GENERATED_BODY()
