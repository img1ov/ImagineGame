...
#include "IMGCheatManager.generated.h"
...
DECLARE_LOG_CATEGORY_EXTERN(LogIMGCheat, Log, All);
...
class UIMGCheatManager : public UCheatManager
{
	GENERATED_BODY()
...
protected:
	...
	void ApplySetByCallerDamage(UIMGAbilitySystemComponent* IMGASC, float DamageAmount);
	void ApplySetByCallerHeal(UIMGAbilitySystemComponent* IMGASC, float HealAmount);

	UIMGAbilitySystemComponent* GetPlayerAbilitySystemComponent() const;
};
