...
#include "IMGSafeZoneEditor.generated.h"
...
UCLASS(Abstract)
class UIMGSafeZoneEditor : public UCommonActivatableWidget, public IGameSettingActionInterface
{
	GENERATED_BODY()
...
public:
	UIMGSafeZoneEditor(const FObjectInitializer& Initializer);
