...
#include "IMGBrightnessEditor.generated.h"
...
UCLASS(Abstract)
class UIMGBrightnessEditor : public UCommonActivatableWidget, public IGameSettingActionInterface
{
	GENERATED_BODY()
...
public:
	UIMGBrightnessEditor(const FObjectInitializer& Initializer);
