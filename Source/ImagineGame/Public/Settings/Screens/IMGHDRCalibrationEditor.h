...
#include "IMGHDRCalibrationEditor.generated.h"
...
UCLASS(Abstract)
class UIMGHDRCalibrationEditor : public UCommonActivatableWidget, public IGameSettingActionInterface
{
	GENERATED_BODY()

public:
	UIMGHDRCalibrationEditor(const FObjectInitializer& Initializer);
