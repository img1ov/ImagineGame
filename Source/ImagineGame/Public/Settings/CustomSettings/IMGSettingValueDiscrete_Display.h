...
#include "IMGSettingValueDiscrete_Display.generated.h"

class UIMGSetting;
class UObject;

UCLASS()
class UIMGSettingValueDiscrete_Display : public UGameSettingValueDiscrete
{
	GENERATED_BODY()

public:

	UIMGSettingValueDiscrete_Display();
