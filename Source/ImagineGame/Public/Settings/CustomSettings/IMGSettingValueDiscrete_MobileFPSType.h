...
//#include "Settings/IMGMobilePerformance.h"
#include "GameSettingValueDiscrete.h"

#include "IMGSettingValueDiscrete_MobileFPSType.generated.h"
...
UCLASS()
class UIMGSettingValueDiscrete_MobileFPSType : public UGameSettingValueDiscrete
{
	GENERATED_BODY()

public:

	UIMGSettingValueDiscrete_MobileFPSType();
