...
#include "IMGSettingValueDiscrete_Resolution.generated.h"
...
UCLASS()
class UIMGSettingValueDiscrete_Resolution : public UGameSettingValueDiscrete
{
	GENERATED_BODY()

public:

	UIMGSettingValueDiscrete_Resolution();
