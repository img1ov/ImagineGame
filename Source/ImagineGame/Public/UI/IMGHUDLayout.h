...
#include "IMGActivatableWidget.h"
#include "Containers/Ticker.h"
#include "GameplayTagContainer.h"

#include "IMGHUDLayout.generated.h"

class UCommonActivatableWidget;
class UObject;
class UIMGControllerDisconnectedScreen;
 ...
 */
UCLASS(Abstract, BlueprintType, Blueprintable, Meta = (DisplayName = "IMG HUD Layout", Category = "IMG|HUD"))
class UIMGHUDLayout : public UIMGActivatableWidget
{
	GENERATED_BODY()

public:

	UIMGHUDLayout(const FObjectInitializer& ObjectInitializer);
...
protected:
	...
	*/
	...
	TSubclassOf<UIMGControllerDisconnectedScreen> ControllerDisconnectedScreen;
