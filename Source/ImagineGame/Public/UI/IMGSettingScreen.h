...
#include "IMGSettingScreen.generated.h"

class UGameSettingRegistry;
class UIMGTabListWidgetBase;
class UObject;

UCLASS(Abstract, meta = (Category = "Settings", DisableNativeTick))
class UIMGSettingScreen : public UGameSettingScreen
{
	GENERATED_BODY()
...
protected:
	...
	TObjectPtr<UIMGTabListWidgetBase> TopSettingsTabs;
