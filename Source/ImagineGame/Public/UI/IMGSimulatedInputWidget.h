...
#include "IMGSimulatedInputWidget.generated.h"
 ...
 */
UCLASS(MinimalAPI, meta=( DisplayName="IMG Simulated Input Widget" ))
class UIMGSimulatedInputWidget : public UCommonUserWidget
{
	GENERATED_BODY()
	
public:
	
	UE_API UIMGSimulatedInputWidget(const FObjectInitializer& ObjectInitializer);
