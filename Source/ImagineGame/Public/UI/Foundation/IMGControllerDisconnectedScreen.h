...
#include "IMGControllerDisconnectedScreen.generated.h"
...
class UIMGControllerDisconnectedScreen : public UCommonActivatableWidget
{
	GENERATED_BODY()
public:
	UIMGControllerDisconnectedScreen(const FObjectInitializer& ObjectInitializer);
