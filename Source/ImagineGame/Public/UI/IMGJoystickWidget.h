...
#include "IMGJoystickWidget.generated.h"
...
/**
 *  A UMG wrapper for the IMG virtual joystick.
 *
 ...
 */
UCLASS(MinimalAPI, meta=( DisplayName="IMG Joystick" ))
class UIMGJoystickWidget : public UIMGSimulatedInputWidget
{
	GENERATED_BODY()
	
public:
	
	UE_API UIMGJoystickWidget(const FObjectInitializer& ObjectInitializer);
