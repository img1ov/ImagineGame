...
#include "IMGCharacterPartTypes.generated.h"
...
struct FIMGCharacterPartHandle
{
	GENERATED_BODY()
...
struct FIMGCharacterPart
{
	...
	static bool AreEquivalentParts(const FIMGCharacterPart& A, const FIMGCharacterPart& B)
	{
