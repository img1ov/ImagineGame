...
#include "IMGCosmeticAnimationTypes.generated.h"
...
struct FIMGAnimLayerSelectionEntry
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct FIMGAnimLayerSelectionSet
{
	GENERATED_BODY()
	...
	TArray<FIMGAnimLayerSelectionEntry> LayerRules;
...
USTRUCT(BlueprintType)
struct FIMGAnimBodyStyleSelectionEntry
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct FIMGAnimBodyStyleSelectionSet
{
	GENERATED_BODY()
		
	// List of layer rules to apply, first one that matches will be used
	UPROPERTY(EditAnywhere, BlueprintReadWrite, meta=(TitleProperty=Mesh))
	TArray<FIMGAnimBodyStyleSelectionEntry> MeshRules;
