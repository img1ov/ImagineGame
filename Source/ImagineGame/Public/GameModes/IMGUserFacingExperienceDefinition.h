...
#include "IMGUserFacingExperienceDefinition.generated.h"
...
class UIMGUserFacingExperienceDefinition : public UPrimaryDataAsset
{
	GENERATED_BODY()
...
public:
	...
	UPROPERTY(BlueprintReadWrite, EditAnywhere, Category=Experience, meta=(AllowedTypes="IMGExperienceDefinition"))
