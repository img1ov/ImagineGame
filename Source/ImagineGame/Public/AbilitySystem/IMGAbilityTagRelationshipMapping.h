...
#include "IMGAbilityTagRelationshipMapping.generated.h"

class UObject;

USTRUCT()
struct FIMGAbilityTagRelationship
{
	GENERATED_BODY()
 ...
 */
UCLASS()
class IMAGINEGAME_API UIMGAbilityTagRelationshipMapping : public UDataAsset
{
	GENERATED_BODY()
...
private:
	...
	TArray<FIMGAbilityTagRelationship> AbilityTagRelationships;
};
