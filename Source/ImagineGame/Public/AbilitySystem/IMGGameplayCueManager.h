...
#include "IMGGameplayCueManager.generated.h"
...
/**
 * UIMGGameplayCueManager
 *
 * Game-specific manager for gameplay cues
 */
UCLASS()
class UIMGGameplayCueManager : public UGameplayCueManager
{
	GENERATED_BODY()
	
public:
	
	UIMGGameplayCueManager(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
	
	static UIMGGameplayCueManager* Get();
