...
#include "IMGGamePhaseAbility.generated.h"

/**
 * UIMGGamePhaseAbility
 *
 * The base gameplay ability for any ability that is used to change the active game phase.
 */
UCLASS(Abstract, HideCategories = Input)
class UIMGGamePhaseAbility : public UIMGGameplayAbility
{
	GENERATED_BODY()

public:

	UIMGGamePhaseAbility(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
...
protected:
	...
	UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, Category = "IMG|Game Phase")
