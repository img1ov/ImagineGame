...
#include "IMGWeaponInstance.h"
#include "AbilitySystem/IMGAbilitySourceInterface.h"

#include "IMGRangedWeaponInstance.generated.h"

class UPhysicalMaterial;

/**
 * UIMGRangedWeaponInstance
 *
 * A piece of equipment representing a ranged weapon spawned and applied to a pawn
 */
UCLASS()
class UIMGRangedWeaponInstance : public UIMGWeaponInstance, public IIMGAbilitySourceInterface
{
	GENERATED_BODY()

public:
	UIMGRangedWeaponInstance(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
...
public:
	...
	//~UIMGEquipmentInstance interface
	virtual void OnEquipped();
	virtual void OnUnequipped();
	//~End of UIMGEquipmentInstance interface

	void AddSpread();

	//~IIMGAbilitySourceInterface interface
	...
	//~End of IIMGAbilitySourceInterface interface
