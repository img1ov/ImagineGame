...
#include "IMGDamageLogDebuggerComponent.generated.h"
...
class UIMGDamageLogDebuggerComponent : public UActorComponent
{
	GENERATED_BODY()

public:

	UIMGDamageLogDebuggerComponent(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
