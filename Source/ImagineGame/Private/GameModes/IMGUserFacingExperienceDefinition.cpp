...
#include UE_INLINE_GENERATED_CPP_BY_NAME(IMGUserFacingExperienceDefinition)

UCommonSession_HostSessionRequest* UIMGUserFacingExperienceDefinition::CreateHostingRequest(const UObject* WorldContextObject) const
{
	...
	if (UIMGReplaySubsystem::DoesPlatformSupportReplays())
	{
		if (bRecordReplay)
		{
