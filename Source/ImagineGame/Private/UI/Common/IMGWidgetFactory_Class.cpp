#include "UI/Common/IMGWidgetFactory_Class.h"

#include "Blueprint/UserWidget.h"

#include UE_INLINE_GENERATED_CPP_BY_NAME(IMGWidgetFactory_Class)

TSubclassOf<UUserWidget> UIMGWidgetFactory_Class::FindWidgetClassForData_Implementation(const UObject* Data) const
{
