...
#include UE_INLINE_GENERATED_CPP_BY_NAME(IMGHUD)
...
AIMGHUD::AIMGHUD(const FObjectInitializer& ObjectInitializer)
	: Super(ObjectInitializer)
{
	PrimaryActorTick.bStartWithTickEnabled = false;
}

void AIMGHUD::PreInitializeComponents()
{
...
void AIMGHUD::EndPlay(const EEndPlayReason::Type EndPlayReason)
{
...
void AIMGHUD::GetDebugActorList(TArray<AActor*>& InOutList)
{
