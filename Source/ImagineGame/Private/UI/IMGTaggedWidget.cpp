...
#include "UI/IMGTaggedWidget.h"

#include UE_INLINE_GENERATED_CPP_BY_NAME(IMGTaggedWidget)

//@TODO: The other TODOs in this file are all related to tag-based showing/hiding of widgets, see UE-142237

UIMGTaggedWidget::UIMGTaggedWidget(const FObjectInitializer& ObjectInitializer)
	: Super(ObjectInitializer)
{
}

void UIMGTaggedWidget::NativeConstruct()
{
...
void UIMGTaggedWidget::NativeDestruct()
{
	if (!IsDesignTime())
	{
...
void UIMGTaggedWidget::SetVisibility(ESlateVisibility InVisibility)
{
...
void UIMGTaggedWidget::OnWatchedTagsChanged()
{
	const bool bHasHiddenTags = false;//@TODO: Foo->HasAnyTags(HiddenByTags);
