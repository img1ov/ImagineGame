...
#include "UI/IMGGameViewportClient.h"

#include "CommonUISettings.h"
#include "ICommonUIModule.h"

#include UE_INLINE_GENERATED_CPP_BY_NAME(IMGGameViewportClient)
...
UIMGGameViewportClient::UIMGGameViewportClient()
	: Super(FObjectInitializer::Get())
{
}

void UIMGGameViewportClient::Init(struct FWorldContext& WorldContext, UGameInstance* OwningGameInstance, bool bCreateNewAudioDevice)
{
