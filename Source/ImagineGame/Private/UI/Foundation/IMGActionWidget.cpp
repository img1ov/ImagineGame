#include "UI/Foundation/IMGActionWidget.h"
...
#include UE_INLINE_GENERATED_CPP_BY_NAME(IMGActionWidget)

FSlateBrush UIMGActionWidget::GetIcon() const
{
...
UEnhancedInputLocalPlayerSubsystem* UIMGActionWidget::GetEnhancedInputSubsystem() const
{
