...
#include UE_INLINE_GENERATED_CPP_BY_NAME(IMGHUDLayout)
...
UIMGHUDLayout::UIMGHUDLayout(const FObjectInitializer& ObjectInitializer)
...
void UIMGHUDLayout::NativeOnInitialized()
{
...
void UIMGHUDLayout::NativeDestruct()
{
...
void UIMGHUDLayout::HandleEscapeAction()
{
...
void UIMGHUDLayout::HandleInputDeviceConnectionChanged(EInputDeviceConnectionState NewConnectionState, FPlatformUserId PlatformUserId, FInputDeviceId InputDeviceId)
{
...
void UIMGHUDLayout::HandleInputDevicePairingChanged(FInputDeviceId InputDeviceId, FPlatformUserId NewUserPlatformId, FPlatformUserId OldUserPlatformId)
{
	const FPlatformUserId OwningLocalPlayerId = GetOwningLocalPlayer()->GetPlatformUserId();
...
bool UIMGHUDLayout::ShouldPlatformDisplayControllerDisconnectScreen() const
{
...
void UIMGHUDLayout::NotifyControllerStateChangeForDisconnectScreen()
{
...
void UIMGHUDLayout::ProcessControllerDevicesHavingChangedForDisconnectScreen()
{
	// We should only ever get here if we have bound to the controller state change delegates
	ensure(ShouldPlatformDisplayControllerDisconnectScreen());
...
void UIMGHUDLayout::DisplayControllerDisconnectedMenu_Implementation()
{
	UE_LOG(LogIMG, Log, TEXT("[%hs] Display controller disconnected menu!"), __func__);
...
void UIMGHUDLayout::HideControllerDisconnectedMenu_Implementation()
{
	UE_LOG(LogIMG, Log, TEXT("[%hs] Hide controller disconnected menu!"), __func__);
