...
#include "Settings/CustomSettings/IMGSettingValueDiscrete_Language.h"
...
#include UE_INLINE_GENERATED_CPP_BY_NAME(IMGSettingValueDiscrete_Language)

#define LOCTEXT_NAMESPACE "IMG"

static const int32 SettingSystemDefaultLanguageIndex = 0;

UIMGSettingValueDiscrete_Language::UIMGSettingValueDiscrete_Language()
{
}

void UIMGSettingValueDiscrete_Language::OnInitialized()
{
	Super::OnInitialized();
...
void UIMGSettingValueDiscrete_Language::StoreInitial()
{
	// ?
}

void UIMGSettingValueDiscrete_Language::OnApply()
{
...
void UIMGSettingValueDiscrete_Language::ResetToDefault()
{
	SetDiscreteOptionByIndex(SettingSystemDefaultLanguageIndex);
}

void UIMGSettingValueDiscrete_Language::RestoreToInitial()
{
	if (UIMGSettingsShared* Settings = CastChecked<UIMGLocalPlayer>(LocalPlayer)->GetSharedSettings())
	{
...
void UIMGSettingValueDiscrete_Language::SetDiscreteOptionByIndex(int32 Index)
{
	if (UIMGSettingsShared* Settings = CastChecked<UIMGLocalPlayer>(LocalPlayer)->GetSharedSettings())
	{
...
int32 UIMGSettingValueDiscrete_Language::GetDiscreteOptionIndex() const
{
	if (const UIMGSettingsShared* Settings = CastChecked<UIMGLocalPlayer>(LocalPlayer)->GetSharedSettings())
	{
...
TArray<FText> UIMGSettingValueDiscrete_Language::GetDiscreteOptions() const
{
