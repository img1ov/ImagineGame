...
void UIMGGameSettingRegistry::AddDLCPage(UGameSettingCollection* Screen, UIMGLocalPlayer* InLocalPlayer)
{
	...
	PlatformDLC->RegisterInitializationCallback([
		WeakThis    = TWeakObjectPtr<UIMGGameSettingRegistry>(this),
		WeakDLCPage = TWeakObjectPtr<UGameSettingCollectionPage>(DLCPage),
		InitCondition,
		PlatformDLC
	]()
	{
		UIMGGameSettingRegistry* This        = WeakThis.Get();
