...
#include "Settings/Screens/IMGBrightnessEditor.h"
...
#include UE_INLINE_GENERATED_CPP_BY_NAME(IMGBrightnessEditor)
...
UIMGBrightnessEditor::UIMGBrightnessEditor(const FObjectInitializer& Initializer)
	: Super(Initializer)
{
...
void UIMGBrightnessEditor::NativeOnInitialized()
{
	Super::NativeOnInitialized();
	Switcher_SafeZoneMessage->SetActiveWidget(RichText_Default);
}

void UIMGBrightnessEditor::NativeOnActivated()
{
...
bool UIMGBrightnessEditor::ExecuteActionForSetting_Implementation(FGameplayTag ActionTag, UGameSetting* InSetting)
{
...
FReply UIMGBrightnessEditor::NativeOnAnalogValueChanged(const FGeometry& InGeometry, const FAnalogInputEvent& InAnalogEvent)
{
...
FReply UIMGBrightnessEditor::NativeOnMouseWheel(const FGeometry& InGeometry, const FPointerEvent& InMouseEvent)
{
...
void UIMGBrightnessEditor::HandleInputModeChanged(ECommonInputType InInputType)
{
...
void UIMGBrightnessEditor::HandleBackClicked()
{
	DeactivateWidget();
	SSafeZone::SetGlobalSafeZoneScale(UIMGSettingsLocal::Get()->GetSafeZone());
}

void UIMGBrightnessEditor::HandleDoneClicked()
{
