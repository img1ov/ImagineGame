...
static TAutoConsoleVariable<bool> CVarLatencyMarkersRequireNVIDIA(TEXT("IMG.Settings.LatencyMarkersRequireNVIDIA"),
	true,
...
public:
	...
	{
		if (!UIMGSettingsLocal::DoesPlatformSupportLatencyTrackingStats())
		{
...
public:
	...
	virtual void GatherEditState(const ULocalPlayer * InLocalPlayer, FGameSettingEditableState & InOutEditState) const override
	{
		if (!UIMGSettingsLocal::DoesPlatformSupportLatencyMarkers())
		{
			InOutEditState.Disable(LOCTEXT("PlatformDoesNotSupportLatencyMarkers", "Latency markers are not supported on this device"));
		}

		// IMG is only going to use the "Reflex" plugin to track these latency stats, so restrict these settings to NVIDIA devices.
...
void UIMGGameSettingRegistry::AddPerformanceStatPage(UGameSettingCollection* PerfStatsOuterCategory, UIMGLocalPlayer* InLocalPlayer)
{
	//----------------------------------------------------------------------------------
	{
		static_assert((int32)EIMGDisplayablePerformanceStat::Count == 18, "Consider updating this function to deal with new performance stats");
		...
		////////////////////////////////////////////////////////////////////////////////////
		{
			...
			//----------------------------------------------------------------------------------
			{
				UIMGSettingValueDiscrete_PerfStat* Setting = NewObject<UIMGSettingValueDiscrete_PerfStat>();
				Setting->SetStat(EIMGDisplayablePerformanceStat::ClientFPS);
			...
			{
				UIMGSettingValueDiscrete_PerfStat* Setting = NewObject<UIMGSettingValueDiscrete_PerfStat>();
				Setting->SetStat(EIMGDisplayablePerformanceStat::ServerFPS);
			...
			{
				UIMGSettingValueDiscrete_PerfStat* Setting = NewObject<UIMGSettingValueDiscrete_PerfStat>();
				Setting->SetStat(EIMGDisplayablePerformanceStat::FrameTime);
			...
			{
				UIMGSettingValueDiscrete_PerfStat* Setting = NewObject<UIMGSettingValueDiscrete_PerfStat>();
				Setting->SetStat(EIMGDisplayablePerformanceStat::IdleTime);
			...
			{
				UIMGSettingValueDiscrete_PerfStat* Setting = NewObject<UIMGSettingValueDiscrete_PerfStat>();
				Setting->SetStat(EIMGDisplayablePerformanceStat::FrameTime_GameThread);
			...
			{
				UIMGSettingValueDiscrete_PerfStat* Setting = NewObject<UIMGSettingValueDiscrete_PerfStat>();
				Setting->SetStat(EIMGDisplayablePerformanceStat::FrameTime_RenderThread);
			...
			{
				UIMGSettingValueDiscrete_PerfStat* Setting = NewObject<UIMGSettingValueDiscrete_PerfStat>();
				Setting->SetStat(EIMGDisplayablePerformanceStat::FrameTime_RHIThread);
			...
			{
				UIMGSettingValueDiscrete_PerfStat* Setting = NewObject<UIMGSettingValueDiscrete_PerfStat>();
				Setting->SetStat(EIMGDisplayablePerformanceStat::FrameTime_GPU);
		...
		////////////////////////////////////////////////////////////////////////////////////
		{
			...
			{
				UIMGSettingValueDiscrete_PerfStat* Setting = NewObject<UIMGSettingValueDiscrete_PerfStat>();
				Setting->SetStat(EIMGDisplayablePerformanceStat::Ping);
			...
			{
				UIMGSettingValueDiscrete_PerfStat* Setting = NewObject<UIMGSettingValueDiscrete_PerfStat>();
				Setting->SetStat(EIMGDisplayablePerformanceStat::PacketLoss_Incoming);
			...
			{
				UIMGSettingValueDiscrete_PerfStat* Setting = NewObject<UIMGSettingValueDiscrete_PerfStat>();
				Setting->SetStat(EIMGDisplayablePerformanceStat::PacketLoss_Outgoing);
			...
			{
				UIMGSettingValueDiscrete_PerfStat* Setting = NewObject<UIMGSettingValueDiscrete_PerfStat>();
				Setting->SetStat(EIMGDisplayablePerformanceStat::PacketRate_Incoming);
			...
			{
				UIMGSettingValueDiscrete_PerfStat* Setting = NewObject<UIMGSettingValueDiscrete_PerfStat>();
				Setting->SetStat(EIMGDisplayablePerformanceStat::PacketRate_Outgoing);
			...
			{
				UIMGSettingValueDiscrete_PerfStat* Setting = NewObject<UIMGSettingValueDiscrete_PerfStat>();
				Setting->SetStat(EIMGDisplayablePerformanceStat::PacketSize_Incoming);
			...
			{
				UIMGSettingValueDiscrete_PerfStat* Setting = NewObject<UIMGSettingValueDiscrete_PerfStat>();
				Setting->SetStat(EIMGDisplayablePerformanceStat::PacketSize_Outgoing);
		...
		////////////////////////////////////////////////////////////////////////////////////
		{
			...
			//----------------------------------------------------------------------------------
			{
				...
				Setting->SetDefaultValue(UIMGSettingsLocal::DoesPlatformSupportLatencyTrackingStats());
			...
			{
				UIMGSettingValueDiscrete_PerfStat* Setting = NewObject<UIMGSettingValueDiscrete_PerfStat>();
				Setting->SetStat(EIMGDisplayablePerformanceStat::Latency_Total);
			...
			{
				UIMGSettingValueDiscrete_PerfStat* Setting = NewObject<UIMGSettingValueDiscrete_PerfStat>();
				Setting->SetStat(EIMGDisplayablePerformanceStat::Latency_Game);
			...
			{
				UIMGSettingValueDiscrete_PerfStat* Setting = NewObject<UIMGSettingValueDiscrete_PerfStat>();
				Setting->SetStat(EIMGDisplayablePerformanceStat::Latency_Render);
