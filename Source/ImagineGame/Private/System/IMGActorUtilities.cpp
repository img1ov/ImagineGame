...
#include "System/IMGActorUtilities.h"

#include "GameFramework/Actor.h"

#include UE_INLINE_GENERATED_CPP_BY_NAME(IMGActorUtilities)

EBlueprintExposedNetMode UIMGActorUtilities::SwitchOnNetMode(const UObject* WorldContextObject)
{
