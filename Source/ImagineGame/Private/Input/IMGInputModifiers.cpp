...
#include "Input/IMGInputModifiers.h"
...
#include UE_INLINE_GENERATED_CPP_BY_NAME(IMGInputModifiers)

DEFINE_LOG_CATEGORY_STATIC(LogIMGInputModifiers, Log, All);

//////////////////////////////////////////////////////////////////////
// IMGInputModifiersHelpers

namespace IMGInputModifiersHelpers
{
	/** Returns the owning IMGLocalPlayer of an Enhanced Player Input pointer */
	static UIMGLocalPlayer* GetLocalPlayer(const UEnhancedPlayerInput* PlayerInput)
	{
		if (PlayerInput)
		{
			if (APlayerController* PC = Cast<APlayerController>(PlayerInput->GetOuter()))
			{
				return Cast<UIMGLocalPlayer>(PC->GetLocalPlayer());
			}
		}
		return nullptr;
	}
...
//////////////////////////////////////////////////////////////////////
// UIMGSettingBasedScalar

FInputActionValue UIMGSettingBasedScalar::ModifyRaw_Implementation(const UEnhancedPlayerInput* PlayerInput, FInputActionValue CurrentValue, float DeltaTime)
{
	...
	{
		if (UIMGLocalPlayer* LocalPlayer = IMGInputModifiersHelpers::GetLocalPlayer(PlayerInput))
		{
			const UClass* SettingsClass = UIMGSettingsShared::StaticClass();
			UIMGSettingsShared* SharedSettings = LocalPlayer->GetSharedSettings();
...
//////////////////////////////////////////////////////////////////////
// UIMGInputModifierDeadZone

FInputActionValue UIMGInputModifierDeadZone::ModifyRaw_Implementation(const UEnhancedPlayerInput* PlayerInput, FInputActionValue CurrentValue, float DeltaTime)
{
	EInputActionValueType ValueType = CurrentValue.GetValueType();
	UIMGLocalPlayer* LocalPlayer = IMGInputModifiersHelpers::GetLocalPlayer(PlayerInput);
	if (ValueType == EInputActionValueType::Boolean || !LocalPlayer)
	{
		return CurrentValue;
	}

	UIMGSettingsShared* Settings = LocalPlayer->GetSharedSettings();
	ensure(Settings);
...
FLinearColor UIMGInputModifierDeadZone::GetVisualizationColor_Implementation(FInputActionValue SampleValue, FInputActionValue FinalValue) const
{
...
//////////////////////////////////////////////////////////////////////
// UIMGInputModifierGamepadSensitivity

FInputActionValue UIMGInputModifierGamepadSensitivity::ModifyRaw_Implementation(const UEnhancedPlayerInput* PlayerInput, FInputActionValue CurrentValue, float DeltaTime)
{
	...
	const EIMGGamepadSensitivity Sensitivity = (TargetingType == EIMGTargetingType::Normal) ? Settings->GetGamepadLookSensitivityPreset() : Settings->GetGamepadTargetingSensitivityPreset();
...
//////////////////////////////////////////////////////////////////////
// UIMGInputModifierAimInversion

FInputActionValue UIMGInputModifierAimInversion::ModifyRaw_Implementation(const UEnhancedPlayerInput* PlayerInput, FInputActionValue CurrentValue, float DeltaTime)
{
	UIMGLocalPlayer* LocalPlayer = IMGInputModifiersHelpers::GetLocalPlayer(PlayerInput);
	if (!LocalPlayer)
	{
