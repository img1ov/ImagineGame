...
#include UE_INLINE_GENERATED_CPP_BY_NAME(IMGHotfixManager)

int32 UIMGHotfixManager::GameHotfixCounter = 0;

UIMGHotfixManager::UIMGHotfixManager()
{
#if !UE_BUILD_SHIPPING
	OnScreenMessageHandle = FCoreDelegates::OnGetOnScreenMessages.AddUObject(this, &UIMGHotfixManager::GetOnScreenMessages);
...
void UIMGHotfixManager::Init()
{
	Super::Init();
}

void UIMGHotfixManager::OnHotfixCompleted(EHotfixResult HotfixResult)
{
	...
	if (bHasPendingDeviceProfileHotfix)
	{
		...
		UIMGSettingsLocal* GameSettings = UIMGSettingsLocal::Get();
...
bool UIMGHotfixManager::WantsHotfixProcessing(const FCloudFileHeader& FileHeader)
{
...
bool UIMGHotfixManager::HotfixIniFile(const FString& FileName, const FString& IniData)
{
...
bool UIMGHotfixManager::ApplyHotfixProcessing(const FCloudFileHeader& FileHeader)
{
...
bool UIMGHotfixManager::ShouldWarnAboutMissingWhenPatchingFromIni(const FString& AssetPath) const
{
	return AssetPath.StartsWith(TEXT("/Engine/")) || AssetPath.StartsWith(TEXT("/Game/"));
}

void UIMGHotfixManager::PatchAssetsFromIniFiles()
{
#if ENABLE_SHARED_MEMORY_TRACKER
...
void UIMGHotfixManager::OnHotfixAvailablityCheck(const TArray<FCloudFileHeader>& PendingChangedFiles, const TArray<FCloudFileHeader>& PendingRemoveFiles)
{
...
#if !UE_BUILD_SHIPPING
void UIMGHotfixManager::GetOnScreenMessages(TMultiMap<FCoreDelegates::EOnScreenMessageSeverity, FText>& OutMessages)
{
	// TODO Any messages/errors.
}
#endif // !UE_BUILD_SHIPPING

void UIMGHotfixManager::RequestPatchAssetsFromIniFiles()
{
...
void UIMGHotfixManager::StartHotfixProcess()
{
	if (GIsEditor)
	{
