...
#include UE_INLINE_GENERATED_CPP_BY_NAME(IMGPlatformEmulationSettings)

#define LOCTEXT_NAMESPACE "IMGCheats"

UIMGPlatformEmulationSettings::UIMGPlatformEmulationSettings()
{
}

FName UIMGPlatformEmulationSettings::GetCategoryName() const
{
	return FApp::GetProjectName();
}

FName UIMGPlatformEmulationSettings::GetPretendBaseDeviceProfile() const
{
	return PretendBaseDeviceProfile;
}

FName UIMGPlatformEmulationSettings::GetPretendPlatformName() const
{
	return PretendPlatform;
}

#if WITH_EDITOR
void UIMGPlatformEmulationSettings::PostEditChangeProperty(FPropertyChangedEvent& PropertyChangedEvent)
{
...
void UIMGPlatformEmulationSettings::PostReloadConfig(FProperty* PropertyThatWasLoaded)
{
...
void UIMGPlatformEmulationSettings::PostInitProperties()
{
...
void UIMGPlatformEmulationSettings::OnPlayInEditorStarted() const
{
...
void UIMGPlatformEmulationSettings::ApplySettings()
{
...
void UIMGPlatformEmulationSettings::ChangeActivePretendPlatform(FName NewPlatformName)
{
...
TArray<FName> UIMGPlatformEmulationSettings::GetKnownPlatformIds() const
{
...
TArray<FName> UIMGPlatformEmulationSettings::GetKnownDeviceProfiles() const
{
	TArray<FName> Results;
...
void UIMGPlatformEmulationSettings::PickReasonableBaseDeviceProfile()
{
