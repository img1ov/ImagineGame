#include "Interaction/Abilities/IMGGameplayAbility_Interact.h"
...
#include UE_INLINE_GENERATED_CPP_BY_NAME(IMGGameplayAbility_Interact)
...
UIMGGameplayAbility_Interact::UIMGGameplayAbility_Interact(const FObjectInitializer& ObjectInitializer)
...
void UIMGGameplayAbility_Interact::ActivateAbility(const FGameplayAbilitySpecHandle Handle, const FGameplayAbilityActorInfo* ActorInfo, const FGameplayAbilityActivationInfo ActivationInfo, const FGameplayEventData* TriggerEventData)
{
...
void UIMGGameplayAbility_Interact::UpdateInteractions(const TArray<FInteractionOption>& InteractiveOptions)
{
	if (AIMGPlayerController* PC = GetIMGPlayerControllerFromActorInfo())
	{
		if (UIMGIndicatorManagerComponent* IndicatorManager = UIMGIndicatorManagerComponent::GetComponent(PC))
		{
...
void UIMGGameplayAbility_Interact::TriggerInteraction()
{
