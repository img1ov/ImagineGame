...
#include "IMGEditorValidator.generated.h"

class UObject;

class FIMGValidationMessageGatherer : public FOutputDevice
{
public:
	FIMGValidationMessageGatherer()
		: FOutputDevice()
	{
		GLog->AddOutputDevice(this);
	}

	virtual ~FIMGValidationMessageGatherer()
	{
...
UCLASS(Abstract)
class UIMGEditorValidator : public UEditorValidatorBase
{
	GENERATED_BODY()
